...
2. **Conexão com a plataforma**: O usuário visita a plataforma SmartTicket e clica em um botão para se conectar com sua carteira criptográfica. Esse botão pode ser rotulado como "Conectar carteira", "Login com MetaMask" ou algo semelhante.
